...
module.exports = function (grunt) {
    ...
    var JS_DIR = 'public/js/app',
        ...
        PROJECT_ID = grunt.option('pid') || 'recommendme',
        CLIENT_ID = grunt.option('cid') || 'IfjosXph475gSJukwXnYAZd2XFc1yqya',
        REDIRECT_URI = grunt.option('ruri') || 'http://recommend-me-storefront.cfapps.io',
