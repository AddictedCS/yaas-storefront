...
module.exports = function (grunt) {
    ...
    var JS_DIR = 'public/js/app',
        ...
        PROJECT_ID = grunt.option('pid') || 'nemoaistorefront',
        CLIENT_ID = grunt.option('cid') || 'Zi2cnm9yYdUsWJdY5AvPioefdIbNi5FG',
        REDIRECT_URI = grunt.option('ruri') || 'http://nemo-ai-storefront-demo.cfapps.io',
